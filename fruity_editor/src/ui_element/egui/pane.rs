...
pub fn draw_pane_grid<'a>(elem: PaneGrid, ui: &mut egui::Ui) {
    ...
    egui::TopBottomPanel::bottom("bottom_panel")
        ...
        .show_inside(ui, |ui| {
            draw_pane(bottom_panes.get(), ui);
        });
}

pub fn draw_pane<'a>(panes: Vec<Pane>, ui: &mut egui::Ui) {
    // TODO: Add tab system
    if let Some(first_pane) = panes.get(0) {
        ...
        draw_element((first_pane.render)(), ui)
    }
}
